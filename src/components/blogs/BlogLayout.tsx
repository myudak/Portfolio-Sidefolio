      ...
      <article>
        <header className="flex flex-col">
          <Link
            ...
            className="group mb-4 flex h-10 w-10 items-center justify-center rounded-full dark:bg-neutral-800 bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 transition  "
          >
